...
>
    <div class="flex rounded-md shadow-sm relative my-4">
        <label
            for="{{ $searchInput->key }}"
            class="inline-flex items-center px-4 rounded-l-md border border-r-0 border-zinc-300 bg-zinc-50 text-zinc-500 text-sm"
        >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-zinc-400" viewBox="0 0 20 20" fill="currentColor">
        ...
        <input
            ...
            type="text"
            class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-indigo-500 focus:border-indigo-500 text-sm border-zinc-300  dark:text-white dark:border-zinc-600 dark:bg-zinc-700 dark:placeholder-zinc-400"
