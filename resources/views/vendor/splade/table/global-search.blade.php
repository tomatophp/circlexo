<div class="relative">
    <input
      class="block w-full sm:pl-9 text-sm rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 border-zinc-200  dark:text-white dark:border-zinc-600 dark:bg-zinc-700 dark:placeholder-zinc-400"
