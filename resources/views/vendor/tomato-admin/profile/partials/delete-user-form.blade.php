    ...
    <x-splade-modal name="confirm-user-deletion">
        <x-splade-form dusk="confirm-user-deletion" method="delete" :action="route('admin.profile.destroy')">
            ...
            <div class="mt-6 flex justify-end">
                <button type="button" @click.prevent="modal.close" class="inline-flex rounded-md shadow-sm border border-zinc-300 bg-white text-zinc-700 hover:bg-zinc-50 font-bold py-2 px-4 focus:outline-none focus:shadow-outline">
