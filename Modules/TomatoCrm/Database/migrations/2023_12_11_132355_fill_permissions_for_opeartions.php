...

{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
           ...
           "admin.accounts.import.store",
           "admin.accounts.password",
           "admin.accounts.password.update",
           "admin.accounts.notifications.send",
           "admin.accounts.notifications",
           "admin.accounts.notifications.index",
           "admin.accounts.address",
           "admin.accounts.address.add"
        ]);
    ...
    {
        if(class_exists(\TomatoPHP\TomatoRoles\Services\TomatoRoles::class)){
