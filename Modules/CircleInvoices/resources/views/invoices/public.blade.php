...
<x-circle-xo-public-profile-layout :account="$invoice->account">
    <div class="flex justify-center">
        <div class="my-8 mx-8 lg:mx-16 bg-zinc-800 rounded-lg border border-zinc-700 w-full overflow-hidden">
            ...
            <div class="p-4">
                ...
                <div class="flex justify-start gap-2 pt-3 border-t border-zinc-700">
                    <x-tomato-admin-button warning label="{{__('Print')}}" :href="route('invoices.public.print', $invoice->uuid)"/>
                </div>
            </div>
        </div>
    </div>
