...
@section('content')
    <x-splade-form :default="[
        'logo' => auth('accounts')->user()->getMedia('logo')->first()?->getUrl() ?: null,
        'uuid' => str(str()->uuid())->explode('-')[0],
...
]"  action="{{route('profile.invoices.store')}}" method="post">
        <div class="grid grid-cols-12 w-full">
            <div class="col-span-12 lg:col-span-3 flex flex-col justify-start gap-4 w-full">
                ...
                <x-splade-textarea v-if="!form.contact_id" autosize name="billed_to" :label="__('Billed To')" @input="form.shipped_to = form.billed_to" type="text"  :placeholder="__('Billed To')" />
                <x-splade-textarea v-if="!form.contact_id" autosize name="shipped_to" :label="__('Shipped To')" type="text"  :placeholder="__('Shipped To')" />
            </div>
        ...
        <div class="flex justify-start gap-2 pt-3 col-span-12">
