    ...
    <div class="grid grid-cols-1 md:grid-cols-2 h-full">
        <div class="flex justify-center items-start w-full">
            <div class="flex flex-col justify-center text-start gap-2 px-16 py-16 md:py-32">
                <h1 class="text-4xl lg:text-6xl font-bold text-main-600">{{ $section['title'] ?? __('Join Our Hub') }}</h1>
                <h6 class="text-xl md:text-3xl lg:text-4xl font-bold text-zinc-300">
                    {{ $section['description'] ?? __('Full Busincess Services on your profile') }}
                </h6>
                <div class="mt-8">
