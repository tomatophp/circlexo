<x-splade-link :href="route('home')"
               class="flex items-center p-2 text-xl rounded-lg hover:bg-zinc-700 group transition-all">
...
<x-splade-link :href="route('home.marketplace')"
               class="flex items-center p-2 text-xl rounded-lg hover:bg-zinc-700 group transition-all">
...
<x-splade-link :href="route('home.blog')"
               class="flex items-center p-2 text-xl rounded-lg hover:bg-zinc-700 group transition-all">
...
<x-splade-link :href="route('apps.index')"
               class="flex items-center p-2 text-xl rounded-lg hover:bg-zinc-700 group transition-all">
...
@else
    ...
    <x-splade-link :href="route('account.register')"
                   class="flex items-center p-2 text-xl rounded-lg hover:bg-zinc-700 group transition-all">
