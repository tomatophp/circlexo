                        ...
                        <div class="flex flex-col justify-center items-center">
                            @if(!auth('accounts')->user()->hasLiked($post))
                                <x-tomato-admin-tooltip :text="__('Like')">
                                    <x-splade-link preserve-scroll :href="route('home.posts.like', ['username' => $account->username, 'post' => $post])" method="POST" class="w-full">
                            ...
                            @else
                                <x-tomato-admin-tooltip :text="__('Dislike')">
                                    <x-splade-link preserve-scroll :href="route('home.posts.unlike', ['username' => $account->username, 'post' => $post])" method="POST" class="w-full flex justify-start gap-2">
                                        <div class="flex justify-start gap-2">
