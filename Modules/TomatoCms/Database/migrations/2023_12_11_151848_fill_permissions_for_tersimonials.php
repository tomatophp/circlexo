...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.tersimonials.index",
           "admin.tersimonials.api",
           "admin.tersimonials.create",
           "admin.tersimonials.store",
           "admin.tersimonials.show",
           "admin.tersimonials.edit",
           "admin.tersimonials.update",
           "admin.tersimonials.destroy",
           "admin.tersimonials.export",
           "admin.tersimonials.bulk",
