<x-tomato-admin-container label="{{trans('tomato-admin::global.crud.view')}} {{__('downloads')}} #{{$model->id}}">
    ...
    <div class="flex justify-start gap-2 pt-3">
        <x-tomato-admin-button warning label="{{__('Edit')}}" :href="route('admin.downloads.edit', $model->id)"/>
