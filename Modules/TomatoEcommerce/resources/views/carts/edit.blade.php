<x-tomato-admin-container label="{{trans('tomato-admin::global.crud.edit')}} {{__('Cart')}} #{{$model->id}}">
    <x-splade-form class="flex flex-col space-y-4" action="{{route('admin.carts.update', $model->id)}}" method="post" :default="$model">
