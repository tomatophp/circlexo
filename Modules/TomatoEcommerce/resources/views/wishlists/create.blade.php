<x-tomato-admin-container label="{{trans('tomato-admin::global.crud.create')}} {{__('Wishlist')}}">
    <x-splade-form class="flex flex-col space-y-4" action="{{route('admin.wishlists.store')}}" method="post">
