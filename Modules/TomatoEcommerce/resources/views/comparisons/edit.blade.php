<x-tomato-admin-container label="{{trans('tomato-admin::global.crud.edit')}} {{__('Comparison')}} #{{$model->id}}">
    <x-splade-form class="flex flex-col space-y-4" action="{{route('admin.comparisons.update', $model->id)}}" method="post" :default="$model">
