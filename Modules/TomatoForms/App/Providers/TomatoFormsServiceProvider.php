...
namespace Modules\TomatoForms\App\Providers;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;
use Modules\TomatoForms\App\Services\RegisterForms;
use Modules\TomatoForms\App\Views\Form;
use Modules\TomatoForms\App\Views\Icon;
use TomatoPHP\TomatoAdmin\Facade\TomatoMenu;
use TomatoPHP\TomatoAdmin\Services\Contracts\Menu;

class TomatoFormsServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'TomatoForms';

    protected string $moduleNameLower = 'tomato-forms';
