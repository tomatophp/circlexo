...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.form-requests.index",
           "admin.form-requests.api",
           "admin.form-requests.create",
           "admin.form-requests.store",
           "admin.form-requests.show",
           "admin.form-requests.edit",
           "admin.form-requests.update",
           "admin.form-requests.destroy",
           "admin.form-requests.export",
           "admin.form-requests.bulk",
