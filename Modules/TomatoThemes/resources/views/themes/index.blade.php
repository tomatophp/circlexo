        ...
        <x-splade-data default="{show: false}">
            <div class="grid grid-cols-2 gap-4">
                @foreach($themes as $theme)
                    <div>
                        <div class="border border-gray-300 bg-center bg-cover w-full h-60" style="background-image: url('{{ str($theme['info']->placeholder)->contains('http') ? $theme['info']->placeholder : url($theme['info']->placeholder)}}')"></div>
