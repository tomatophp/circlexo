...
class FillPermissionsForuserNotifications extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
           "admin.user-notifications.index",
           "admin.user-notifications.api",
           "admin.user-notifications.create",
           "admin.user-notifications.store",
           "admin.user-notifications.show",
           "admin.user-notifications.edit",
           "admin.user-notifications.update",
           "admin.user-notifications.destroy",
           "admin.user-notifications.export",
           "admin.user-notifications.bulk",
