...
class FillPermissionsFornotificationsTemplates extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
           ...
           "admin.notifications-templates.store",
           "admin.notifications-templates.show",
           "admin.notifications-templates.edit",
           "admin.notifications-templates.update",
           "admin.notifications-templates.destroy",
           "admin.notifications-templates.export",
           "admin.notifications-templates.bulk",
