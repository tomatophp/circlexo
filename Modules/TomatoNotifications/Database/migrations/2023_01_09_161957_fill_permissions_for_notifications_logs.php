...
class FillPermissionsFornotificationsLogs extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
           ...
           "admin.notifications-logs.create",
           "admin.notifications-logs.store",
           "admin.notifications-logs.show",
           "admin.notifications-logs.edit",
           "admin.notifications-logs.update",
           "admin.notifications-logs.destroy",
           "admin.notifications-logs.export",
           "admin.notifications-logs.bulk",
