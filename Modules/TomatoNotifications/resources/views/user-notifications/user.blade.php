<x-tomato-admin-container label="{{__('User Notifications')}}">
            ...
            <div class="filament-modal-content">
                        ...
                        <div>
                            <div class="flex flex-col gap-4 rounded-lg @if(!$notification->isRead()) bg-zinc-200 dark:bg-zinc-700 @else bg-zinc-50 dark:bg-zinc-900 @endif  px-4 py-4">
                                <div
                                    ...
                                    <x-splade-link method="delete" :href="route('admin.user-notifications.destroy', $notification->id)" confirm>
                                    ...
                                    @if(!$notification->isRead())
                                        <x-splade-link method="post" :href="route('admin.notifications.read.selected', $notification->id)" confirm>
                ...
                <div class="flex justify-start gap-2">
                    <x-tomato-admin-button
                        ...
                        confirm
                        method="delete"
                        :href="route('admin.notifications.clear')"
                        type="link">
                    ...
                    <x-tomato-admin-button
                        ...
                        confirm
                        method="post"
                        :href="route('admin.notifications.read')"
                        type="link">
