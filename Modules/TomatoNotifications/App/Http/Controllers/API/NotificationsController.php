...
namespace Modules\TomatoNotifications\App\Http\Controllers\API;
...
use Modules\TomatoNotifications\App\Models\UserReadNotification;
...
class NotificationsController extends Controller
{
    ...
    public function update($id){
        ...
        Toast::title(trans(__("updated successfully ")))->success()->autoDismiss(2);
